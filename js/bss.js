...
(function () {
  ...
  function footer() {
    ...
    '<footer class="ftr grain grain--dark"><div class="shell" style="padding-top:clamp(44px,5vw,76px)">' +
      '<div class="ftr__grid">' +
        '<div><p class="ftr__h">When</p><p class="small">Saturday 10/31/26<br>3–8pm</p></div>' +
      ...
      /* The sign-off. The logo gets to be big down here — it is the last
         ...
         chrome scale. "Local Milwaukee Social Events" sits under it in the script
         face, the way a signature sits under a printed mark. */
      '<div class="ftr__signoff">' +
        logo('ftr__logo', 'Bar Scene Socials') +
        '<p class="ftr__tag">Local Milwaukee Social Events</p>' +
      '</div>' +
    '</div></footer>';
  }
